...
if __name__ == "__main__":
    ...
    ax.plot3D([0, 0, a_1[0]], [0, 0, a_1[1]], [0, heave[index], a_1[2]+heave[index]], marker='o', color='blue')
    a_1[0] = a_1[0] + 0
    a_1[1] = a_1[1] + 0
    a_1[2] = a_1[2] + heave[index]
    ax.plot3D([0, a_1[0]], [0, a_1[1]], [0, a_1[2]], marker='o',  color='blue')

    a_2_shift = 0.0
    a_2 = [a_2_shift, 0, 2]
    a_2 = vector_3d_rotation(a_2, 1.57075 / 2, 0, 0)
    ax.plot3D([a_2_shift, a_2_shift, a_2[0]], [0, 0, a_2[1]], [0, heave[index], a_2[2]+heave[index]], marker='o', color='purple')
    a_2[0] = a_2[0] + 0
    a_2[1] = a_2[1] + 0
    a_2[2] = a_2[2] + heave[index]
    ax.plot3D([a_2_shift, a_2[0]], [0, a_2[1]], [0, a_2[2]], marker='o', color='purple')

    a_3_shift = 0.0
    a_3 = [a_3_shift, 0, 3]
    a_3 = vector_3d_rotation(a_3, 1.57075 / 2, 0, 0)
    ax.plot3D([a_3_shift, a_3_shift, a_3[0]], [0, 0, a_3[1]], [0, heave[index], a_3[2]+heave[index]], marker='o', color='red')
    a_3[0] = a_3[0] + 0
    a_3[1] = a_3[1] + 0
    a_3[2] = a_3[2] + heave[index]
